...
@section('content')
    <div class="container">
        ...
        <div class="grid grid-cols-1 gap-5 mt-5 lg:grid-cols-1">
            <div class="card">

                <div class="card-body">
                    <div class="flex flex-row items-center justify-between">
                        <h1 class="text-lg font-extrabold text-gray-500">{{ $page_name }}</h1>
                            ...
                            <tbody>
                                @forelse ($objects as $object)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            {{ number_format($object->sub_total, 2) ?? '' }}
                                        </td>

                                        <td class="px-6 py-4">
                                            {{ number_format($object->discount, 2) ?? '' }}
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="flex">
                                                ...
                                                <form action="{{ route($btn_route_delete, $object->id) }}" method="POST">
                                                    ...
                                                    @csrf
                                                    <button
                                                        class="px-2 py-2 mb-2 text-sm font-medium text-white bg-red-700 rounded-lg focus:outline-none hover:bg-red-800 focus:ring-4 focus:ring-red-300 me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                                                        <svg className="w-[16px] h-[16px] text-gray-800 dark:text-white"
